...
* Mon Apr 10 2023 Anton Midyukov <antohami@altlinux.org> 2.9.128-alt1
- alterator-livecd-install: update russian translation

* Thu Apr 06 2023 Oleg Solovyov <mcpain@altlinux.org> 2.9.127-alt1
- alterator-vm: update string

* Wed Apr 05 2023 Oleg Solovyov <mcpain@altlinux.org> 2.9.126-alt1
- alterator-vm: new translation

* Mon Mar 27 2023 Sergey V Turchin <zerg@altlinux.org> 2.9.125-alt1
- fix alterator-x11 russian translation

* Wed Mar 15 2023 Anton Midyukov <antohami@altlinux.org> 2.9.124-alt1
- alterator-notes: update russian translation and russian help
...
* Mon Oct 31 2022 Sergey V Turchin <zerg@altlinux.org> 2.9.119-alt1
- Update net-eth russian translation
...
* Fri Oct 22 2021 Andrey Cherepanov <cas@altlinux.org> 2.9.99-alt1
- Add Russian translation for alterator-limits (thanks Sergey Kazorin).

* Thu Oct 14 2021 Slava Aseev <ptrnine@altlinux.org> 2.9.98-alt1
- alterator-vm: fix translation

* Wed Sep 29 2021 Ivan Razzhivin <underwit@altlinux.org> 2.9.97-alt1
- alterator-multiseat: update translation
- alterator-secsetup: update translation

* Tue Sep 21 2021 Slava Aseev <ptrnine@altlinux.org> 2.9.96-alt1
- alterator-vm: update translation
...
* Wed Jun 02 2021 Ivan Razzhivin <underwit@altlinux.org> 2.9.91-alt1
- alterator-multiseat: update help
- alterator-multiseat: update translation
...
* Tue Apr 13 2021 Ivan Razzhivin <underwit@altlinux.org> 2.9.87-alt1
- alterator-multiseat: update translation
- alterator-multiseat: update help

* Tue Apr 06 2021 Ivan Razzhivin <underwit@altlinux.org> 2.9.86-alt1
- alterator-multiseat: add translation
- alterator-multiseat: add help

* Thu Mar 04 2021 Ivan Savin <svn17@altlinux.org> 2.9.85-alt1
- alterator-update-kernel: update help

* Tue Mar 02 2021 Ivan Razzhivin <underwit@altlinux.org> 2.9.84-alt1
- alterator-datetime: fix translation
- alterator-datetime: fix help

* Mon Mar 01 2021 Ivan Savin <svn17@altlinux.org> 2.9.83-alt1
- alterator-update-kernel: update translation
...
* Fri Dec 25 2020 Ivan Savin <svn17@altlinux.org> 2.9.79-alt1
- alterator-auth: update translation
